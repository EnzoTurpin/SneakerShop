 ...
 */
final class Version20250218112344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD auteur_id INT NOT NULL, CHANGE role type VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP auteur_id, CHANGE type role VARCHAR(255) NOT NULL');
    }
}
